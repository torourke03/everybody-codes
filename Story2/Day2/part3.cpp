...
int main() {
    ...
    vector<vector<int>> scoresList;
    parseInput("../example3.txt", board, sequences);
    ...
    // TODO: Figure out how to find the min and max scores without reusing slots
    for (auto & scores : scoresList) {
